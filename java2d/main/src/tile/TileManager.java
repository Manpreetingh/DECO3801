...
public class TileManager {
    ...
    public void getTileImage() {
        try {
            ...
            tile[71] = new Tile();
            tile[71].image = ImageIO.read(getClass().getResourceAsStream("/pc_topleft.png"));
            tile[71].collision = true;
            tile[72] = new Tile();
            tile[72].image = ImageIO.read(getClass().getResourceAsStream("/pc_botleft.png"));
            tile[72].collision = true;
            tile[73] = new Tile();
            tile[73].image = ImageIO.read(getClass().getResourceAsStream("/pc_topright.png"));
            tile[73].collision = true;
            tile[74] = new Tile();
            tile[74].image = ImageIO.read(getClass().getResourceAsStream("/pc_botright.png"));
